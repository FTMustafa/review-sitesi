  ...
  },
  {
    ...
    yorumlar: [
      ...
      },
      {
        k_id: 2,
        k_foto: "",
        k_yorum: "Her türlü kombinle uyumlu, hem spor hem de günlük kullanım için ideal.",
      },
      {
        k_id: 3,
        k_foto: "",
        k_yorum: "Yıkandıktan sonra bile ne renginde ne de formunda bir değişiklik oluyor.",
      },
      {
        k_id: 3,
        k_foto: "",
        k_yorum: "Kumaşı yumuşak ama birkaç yıkamadan sonra dikişlerinde gevşeme oldu, kalite konusunda hayal kırıklığı yaşadım.",
      },
    ],
  },
];
